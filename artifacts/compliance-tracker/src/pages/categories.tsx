    ...
    <AppLayout title="Sites">
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle className="font-display">Add Site</DialogTitle>
          </DialogHeader>
          <form onSubmit={handleCreate} id="cat-form" className="space-y-4 py-4">
            <div className="space-y-1.5">
              <Label>Site Name</Label>
              <Input value={name} onChange={e => setName(e.target.value)} placeholder="e.g. Manchester Warehouse" autoFocus />
            </div>
            <div className="space-y-1.5">
