...
import { ArrowLeft, ClipboardCheck, Plus, AlertTriangle, Clock, CheckCircle2, Circle, Loader2 } from "lucide-react";
  ...
  return (
    <AppLayout title={category.name}>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        ...
        <Button onClick={() => { setEditingItem(null); setIsFormOpen(true); }} className="shadow-lg shadow-primary/20 w-full sm:w-auto">
